...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "dev";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "dev.war")
            ...
            .addPackages(false, "jjjjjj") // not recursive to skip package 'nonarquillian'
